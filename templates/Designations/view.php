...
<?php
$this->assign('title', __('Designation'));
$this->Breadcrumbs->add([
    ['title' => 'Home', 'url' => '/'],
    ['title' => 'List Designations', 'url' => ['action' => 'index']],
    ['title' => 'View'],
]);
?>
...
<div class="view card card-primary card-outline">
  <div class="card-header d-sm-flex">
    <h2 class="card-title"><?= h($designation->name) ?></h2>
  </div>
  ...
  <div class="card-footer d-flex">
    <div class="">
      <?= $this->Form->postLink(
          ...
          ['confirm' => __('Are you sure you want to delete # {0}?', $designation->id), 'class' => 'btn btn-danger']
      ) ?>
    </div>
    <div class="ml-auto">
      <?= $this->Html->link(__('Edit'), ['action' => 'edit', $designation->id], ['class' => 'btn btn-secondary']) ?>
