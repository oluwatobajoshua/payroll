...
<div class="view card card-primary card-outline">
  <div class="card-header d-sm-flex">
    <h2 class="card-title"><?= h($gender->name) ?></h2>
  </div>
  ...
  <div class="card-footer d-flex">
    ...
    <div class="ml-auto">
      <?= $this->Html->link(__('Edit'), ['action' => 'edit', $gender->id], ['class' => 'btn btn-secondary']) ?>
...
<div class="related related-childrenDetails view card">
  ...
  <div class="card-body table-responsive p-0">
    <table class="table table-hover text-nowrap">
      ...
      <?php if (empty($gender->children_details)) { ?>
        <tr>
      ...
      <?php }else{ ?>
        <?php foreach ($gender->children_details as $childrenDetails) : ?>
        <tr>
