...
<div class="view card card-primary card-outline">
  <div class="card-header d-sm-flex">
    <h2 class="card-title"><?= h($branch->name) ?></h2>
  </div>
  ...
  <div class="card-footer d-flex">
    <div class="">
      <?= $this->Form->postLink(
          ...
          ['confirm' => __('Are you sure you want to delete # {0}?', $branch->id), 'class' => 'btn btn-danger']
      ) ?>
    </div>
    <div class="ml-auto">
      <?= $this->Html->link(__('Edit'), ['action' => 'edit', $branch->id], ['class' => 'btn btn-secondary']) ?>
