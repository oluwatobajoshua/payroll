...
<?php
$this->assign('title', __('Physical Posture'));
...
<div class="view card card-primary card-outline">
  <div class="card-header d-sm-flex">
    <h2 class="card-title"><?= h($physicalPosture->name) ?></h2>
  </div>
  ...
  <div class="card-footer d-flex">
    ...
    <div class="ml-auto">
      <?= $this->Html->link(__('Edit'), ['action' => 'edit', $physicalPosture->id], ['class' => 'btn btn-secondary']) ?>
