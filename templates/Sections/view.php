...
<div class="view card card-primary card-outline">
  <div class="card-header d-sm-flex">
    <h2 class="card-title"><?= h($section->name) ?></h2>
  </div>
  ...
  <div class="card-footer d-flex">
    <div class="">
      <?= $this->Form->postLink(
          ...
          ['confirm' => __('Are you sure you want to delete # {0}?', $section->id), 'class' => 'btn btn-danger']
      ) ?>
    </div>
    <div class="ml-auto">
      <?= $this->Html->link(__('Edit'), ['action' => 'edit', $section->id], ['class' => 'btn btn-secondary']) ?>
...
<div class="related related-otherDepartments view card">
  ...
  <div class="card-body table-responsive p-0">
    <table class="table table-hover text-nowrap">
      ...
      <?php if (empty($section->other_departments)) { ?>
        <tr>
      ...
      <?php }else{ ?>
        <?php foreach ($section->other_departments as $otherDepartments) : ?>
        <tr>
