...
<div class="view card card-primary card-outline">
  <div class="card-header d-sm-flex">
    <h2 class="card-title"><?= h($local->name) ?></h2>
  </div>
  ...
  <div class="card-footer d-flex">
    <div class="">
      <?= $this->Form->postLink(
          ...
          ['confirm' => __('Are you sure you want to delete # {0}?', $local->id), 'class' => 'btn btn-danger']
      ) ?>
    </div>
    <div class="ml-auto">
      <?= $this->Html->link(__('Edit'), ['action' => 'edit', $local->id], ['class' => 'btn btn-secondary']) ?>
...
<div class="related related-employees view card">
  ...
  <div class="card-body table-responsive p-0">
    <table class="table table-hover text-nowrap">
      ...
      <?php }else{ ?>
        <?php foreach ($local->employees as $employees) : ?>
        <tr>
