 ...
 * @var \App\Model\Entity\HighestEducation $highestEducation
 */
?>

<?php
$this->assign('title', __('Highest Education'));
$this->Breadcrumbs->add([
    ['title' => 'Home', 'url' => '/'],
    ['title' => 'List Highest Educations', 'url' => ['action' => 'index']],
    ['title' => 'View'],
]);
?>
...
<div class="view card card-primary card-outline">
  <div class="card-header d-sm-flex">
    <h2 class="card-title"><?= h($highestEducation->name) ?></h2>
  </div>
  ...
  <div class="card-footer d-flex">
    <div class="">
      <?= $this->Form->postLink(
          __('Delete'),
          ['action' => 'delete', $highestEducation->id],
          ['confirm' => __('Are you sure you want to delete # {0}?', $highestEducation->id), 'class' => 'btn btn-danger']
      ) ?>
    </div>
    <div class="ml-auto">
      <?= $this->Html->link(__('Edit'), ['action' => 'edit', $highestEducation->id], ['class' => 'btn btn-secondary']) ?>
...
<div class="related related-educations view card">
  ...
  <div class="card-body table-responsive p-0">
    <table class="table table-hover text-nowrap">
      ...
      <?php if (empty($highestEducation->educations)) { ?>
        <tr>
      ...
      <?php }else{ ?>
        <?php foreach ($highestEducation->educations as $educations) : ?>
        <tr>
...
<div class="related related-employees view card">
  ...
  <div class="card-body table-responsive p-0">
    <table class="table table-hover text-nowrap">
      ...
      <?php if (empty($highestEducation->employees)) { ?>
        <tr>
      ...
      <?php }else{ ?>
        <?php foreach ($highestEducation->employees as $employees) : ?>
        <tr>
